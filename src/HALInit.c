...
void spiInitailize(void)
{
	...
	SPI_I2S_DMACmd(W5x00_SPI, SPI_I2S_DMAReq_Rx | SPI_I2S_DMAReq_Tx , ENABLE);
	...
	DMA_RX_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)(&(W5x00_SPI->DR));
	...
	DMA_TX_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)(&(W5x00_SPI->DR));
