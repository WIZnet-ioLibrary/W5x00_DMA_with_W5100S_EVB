...
#if defined(SPI_Arduino)
	#define W5x00_DMA_CHANNEL_RX	DMA1_Channel2
	#define W5x00_DMA_CHANNEL_TX	DMA1_Channel3
#else
	#define W5x00_DMA_CHANNEL_RX	DMA1_Channel4
	#define W5x00_DMA_CHANNEL_TX	DMA1_Channel5
#endif
